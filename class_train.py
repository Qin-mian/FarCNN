...
# 分类
CLASS_TYPES = ['0', '1','2','3','4','5']
N_TYPES = len(CLASS_TYPES)

# 加载数据
feature_dir = 'classification/classification'
...
# 优化器目前Adagrad最好
optimizer = Adagrad(model.parameters(), lr=0.02, lr_decay=0)
...
for epoch in range(epochs):
    ...
    if f1 > best_f1:
        best_f1 = f1
        torch.save(model.state_dict(), f'./models/class.pth')
